...
def run(use_adapt, use_dpp, trans_model, data_dir, train_langs, dev_langs, test_langs, use_few_shot, data_format,
    ...
    out_dir = os.path.join(out_dir, "FINE_TUNE/after_en/train_"+",".join(train_langs)+"-test_"+",".join(test_langs) +
    ...
    if use_pretrained_model:
        ...
        pre_train_from_scratch(model, device, dataset, dataset.train, pre_train_config, use_slots, test_langs, writer, out_dir)
