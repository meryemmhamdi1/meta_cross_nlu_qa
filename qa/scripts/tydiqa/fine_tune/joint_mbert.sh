...
echo "FINE-TUNING ON ALL LANGUAGES JOINTLY"
for SEED in 40 42 44 163
do
    python main_fine_tune.py --use-slots --train-langs en --dev-langs ar bn fi id ko ru sw te --test-langs ar bn en fi id ko ru sw te \
