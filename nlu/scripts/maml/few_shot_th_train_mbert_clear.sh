...
python main.py --use-slots --train-langs en --dev-langs th --test-langs es th --k-spt 6 --q-qry 6 \
       --data-dir $data_path --out-dir $results_path --batch-sz 2500 --pre-train-steps 2000 --local_rank 0 \
       --use-pretrained-model --pre-trained-model-name $pre_trained_model_name --use-adapt