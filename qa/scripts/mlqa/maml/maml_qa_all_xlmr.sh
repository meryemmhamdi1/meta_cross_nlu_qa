...
python main_new_data.py --use-slots --train-langs en --dev-langs de --test-langs ar de es hi vi zh \
       --do-lower-case --adam-lr 3e-5 --max-seq-length 384  --doc-stride 128 --save-steps 50 --gradient-accumulation-steps 4 \
      --use-adapt --k-spt 3 --q-qry 3 --data-dir $data_dir --out-dir $results_path --batch-sz 2500 --warmup-steps 500 \
       --pre-train-steps 5000 --local_rank -1 --trans-model "XLMRoberta_base" --model-type "xlm-roberta" \
       --use-pretrained-model --pre-trained-model-name $pre_trained_model_name
...
python main_new_data.py --use-slots --train-langs en --dev-langs es --test-langs ar de es hi vi zh \
       --do-lower-case --adam-lr 3e-5 --max-seq-length 384  --doc-stride 128 --save-steps 50 --gradient-accumulation-steps 4 \
       --use-adapt --k-spt 3 --q-qry 3 --data-dir $data_dir --out-dir $results_path --batch-sz 2500 --warmup-steps 500 \
       --pre-train-steps 5000 --local_rank -1 --trans-model "XLMRoberta_base" --model-type "xlm-roberta" \
       --use-pretrained-model --pre-trained-model-name $pre_trained_model_name