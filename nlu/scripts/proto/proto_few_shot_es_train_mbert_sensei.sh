...
results_path=$user_space"Results/meta_zsl_nlu/FacebookData_PROTO_HYBRID/"
pre_trained_model_name=$user_space"Results/meta_zsl_nlu/FacebookData_BERT_TUNE/train_en-test_es,th/pytorch_model.bin"

CUDA_VISIBLE_DEVICES=1 python -m torch.distributed.launch proto_main.py --use-slots --train-langs en --dev-langs es --test-langs en es th \
