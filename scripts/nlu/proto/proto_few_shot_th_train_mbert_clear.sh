...
python proto_main_l2l.py --use-slots --train-langs en --dev-langs th --test-langs en es th --use-adapt --k-spt 6 --q-qry 6 \
       --data-dir $data_path --out-dir $results_path --batch-sz 2500 --use-pretrained-model \
