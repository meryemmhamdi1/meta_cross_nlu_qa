...
do
    ...
    do
        python main_trans_ada.py --use-adapt --train-langs en --dev-langs $LANG --test-langs ar bn en fi id ko ru sw te \
               --do-lower-case --adam-lr 3e-5 --max-seq-length 384  --doc-stride 128 --save-steps 50 --gradient-accumulation-steps 4 \
               --k-spt 6 --q-qry 6 --data-dir $data_dir --out-dir $results_path --batch-sz 2500 --warmup-steps 500 \
